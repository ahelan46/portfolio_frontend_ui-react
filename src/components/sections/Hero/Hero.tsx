      ...
      <div className={styles.head} data-depth="0.01">
        ...
        <h1 className={styles.h1}>
          <span className={styles.row}>
            {t("hero.h1a")} <em className={styles.serif}><Typewriter words={["Creator", "UI Designer", "Tester", "Web Developer"]} /></em>
          </span>
        </h1>
        ...
        <div className={styles.ctas}>
          ...
          <Button href="#contact" variant="ghost" lead={<span className={styles.play}>▶</span>}>
            {t("hero.cta2")}
          </Button>
        </div>
      </div>
