...
const SOCIALS = [
  { name: "LinkedIn", mark: "linkedin", href: "https://www.linkedin.com/in/ahelan-v-4a4642342/" },
  { name: "GitHub", mark: "github", href: "https://github.com/ahelan46" },
  { name: "Instagram", mark: "instagram", href: "https://www.instagram.com/_x_h_x_l_x_n_/?hl=en" },
  { name: "Email", glyph: "@", href: "mailto:ahelanv2006@gmail.com" },
] as const;
...
export function ConnectHero() {
  ...
  return (
    <section className={styles.connectHero} id="contact-hero" ref={root}>
...
export function ConnectForm() {
  ...
  return (
    <section className={styles.connectFormPage} id="contact-form" ref={root}>
          ...
          <div className={styles.contactGrid}>
              ...
              <div className={styles.contactList}>
                <div className={styles.contactItem}>
                  ...
                  <div className={styles.contactText}>
                    <span>ahelanv2006@gmail.com</span>
                  </div>
                </div>
                <div className={styles.contactItem}>
                  <div className={`${styles.contactIcon} ${styles.iconPink}`}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
                    </svg>
                  </div>
                  <div className={styles.contactText}>
                    <span>+91 7200673492</span>
                  </div>
                </div>
                <div className={styles.contactItem}>
                  <div className={`${styles.contactIcon} ${styles.iconGrey}`}>
                    <svg viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div className={styles.contactText}>
                    ...
                    <span className={styles.subtext}>Not available</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={styles.contactCard}>
              ...
              <form className={styles.contactForm} onSubmit={(e) => e.preventDefault()}>
                ...
                <div className={styles.formGroup}>
                  <label>Message</label>
                  <textarea className={styles.formTextarea} placeholder="Write your message"></textarea>
                </div>
      ...
      <footer className={styles.footer}>
        <span>
          {t("connect.credit")} <b>Ahelan</b>
        </span>
        <a href="#home" className={styles.top}>
          {t("connect.top")}
        </a>
        <span>© 2026 Ahelan </span>
      </footer>
    </section>
  );
}
